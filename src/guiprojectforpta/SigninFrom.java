...
public class SigninFrom extends javax.swing.JFrame {
    ...
    public boolean duplicateCheck(){
        ...
        try{
            String query = "SELECT * FROM tabletae  WHERE Username = '" + us.getText() + "' OR Email = '" + em.getText() + "'";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(em.getText().isEmpty()||nm.getText().isEmpty()||us.getText().isEmpty()||pw.getText().isEmpty()){
                JOptionPane.showMessageDialog(null, "You Need To Put All The Details!");
                ...
                if(dbc.insertData("INSERT INTO tabletae (Email, Name, Username, Password, u_type, u_status) VALUES ('"+em.getText()+"', '"+nm.getText()+"', '"+us.getText()+"', '"+pw.getText()+"', '"+ut.getSelectedItem()+"', 'Pending')")){                                        
